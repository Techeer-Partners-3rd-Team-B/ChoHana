...
export default function Week2() {
  return (
    <div class="min-h-screen px-20">
      ...
      <div class="flex">
        <div class="ml-6">
          <h1 class="text-xl mb-2">공부 내용</h1>
      ...
      <p class="h-8"></p>
      <h2 class="text-2xl font-medium">React-Router의 종류</h2>
      <p class="h-5"></p>
      <h3 class="text-xl">1. HashRouter</h3>
      <p class="h-4"></p>
      ...
      <p class="h-5"></p>
      <h3 class="text-xl">2. BrowserRouter</h3>
      <p class="h-4"></p>
      ...
      <p class="h-8"></p>
      <h2 class="text-2xl font-medium">태그 종류</h2>
      <p class="h-5"></p>
      <h3 class="text-xl">
        1. {"<"}BrowserRouter{">"}
      </h3>
